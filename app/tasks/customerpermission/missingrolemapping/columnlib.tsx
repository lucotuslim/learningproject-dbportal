...
import { getClientWithDbInfo, getAllMissingDbPermissions } from "../serverlib"
    ...
    return (
        <>
            ...
            <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                ...
                >
                    <DialogHeader>
                        <DialogTitle>Client DB Permission Setup New- {customer.GroupName}</DialogTitle>
                    </DialogHeader>
    ...
    useEffect(() => {
        ...
        const load = async () => {
            ...
            try {
                ...
                const result = await getAllMissingDbPermissions(
