...
export const AppConfig = {
  Global: [
    {
      ENCRYPTION_KEY:
        "1,35,69,103,137,171,205,239,18,52,86,120,154,188,222,241,17,34,51,68,85,102,119,136,153,170,187,204,221,238,255,0",
    },
    {
      PWPUSHER_API_URL: "http://192.168.100.152",
    },
  ],
  DocumentExtractionTasksSetting: [
    {
      env: "TestMe",
      GetDocApiToken: {
